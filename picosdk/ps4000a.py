...
ps4000a.PICO_CHANNEL = {k.split('_')[-1]: v for k, v in ps4000a.PS4000A_CHANNEL.items()}
...
ps4000a.PICO_THRESHOLD_DIRECTION = {
    k[8:]: v for k, v in ps4000a.PS4000A_THRESHOLD_DIRECTION.items()
}
